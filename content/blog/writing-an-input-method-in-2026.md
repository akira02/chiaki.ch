...
這篇文章記錄的，就是這幾個月發生的事。前半段是一場數位考古，後半段卻逐漸變成一個語言學問題。因為我很快就發現，讓輸入法「跑起來」只是入場券，真正決定一個注音輸入法好不好用的，是它背後那份詞庫。
...
搭配輸入法目前預設會自動更新詞庫，這樣就能讓上週才出現的名字，這週就打得出來。
...
我原本以為這是一個「把老程式修到能跑」的懷舊專案，結果最耗時間、也最有滋味的部分，是慢慢弄清楚一件事：一個注音輸入法之所以「懂你」，不是什麼聰明的演算法，而是得有人把台灣人實際怎麼打字的證據，一筆一筆的整理起來。

我認為在大語言模型的時代，這件事反而更值得做，實驗很明白地告訴我們，模型可以幫忙判斷，卻不能代替真實文本告訴你台灣人怎麼說話。「相關單位」出現 62 次的語料，與立法院公報裡的「本席」，本質上都是某個特定說話者的口癖，不是語言本身。當大語言模型的用詞逐漸單一化，而你，我們人類，卻還在源源不絕的創造新的詞彙。

詞庫每週會自動吸收新的熱門詞，bigram 層會隨詞庫變動重新產生，它還在成長，我也還在努力。故事還沒寫完，但至少現在，打「天意難測」，出來的會是「天意難測」。

### 如果你願意支持

千秋輸入法 ChiaKey 與詞庫都是永久免費的開源專案，但為了簽章安裝程式，蘋果每年會向開發者收取 100 美元的費用。每週的語料抽取、評估、審核與釋出，都需要時間與機器持續運轉。如果你也是注音使用者，覺得這件事值得有人繼續做，歡迎贊助或者給我一些鼓勵。台灣的朋友可以參考[綠界贊助](https://p.ecpay.com.tw/2A3B186)，信用卡、Apple Pay、ATM 與超商代碼都可以；台灣以外的朋友亦可以透過 [Ko-fi](https://ko-fi.com/A0A21UAIV9)贊助。
